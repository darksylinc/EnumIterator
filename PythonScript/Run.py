...
for root, dir, files in os.walk("."):
	for fileName in files:
		...
		if extension in supportedExtensions and fileWasModified( root, fileName ) \
...
for root, dir, files in os.walk("."):
	for fileName in files:
		...
		fullPath = os.path.join( root, fileName )
		if extension in supportedExtensions and not EnumIterator.wasFileGeneratedByUs( fullPath ):
			print( "****************" + fullPath + "****************" )
...
writeIfModified( rootFolder, "AmalgamationEnum.cpp", outputCpp )
